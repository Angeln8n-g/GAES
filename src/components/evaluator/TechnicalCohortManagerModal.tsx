        ...
        <div className="p-5 sm:p-6 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 shrink-0">
          ...
          <div className="flex items-center gap-2 self-end sm:self-center">
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-[#DA291C] hover:bg-red-700 text-white text-xs font-bold transition-all shadow-md shadow-red-500/25 flex items-center gap-1.5 cursor-pointer active:scale-95 shrink-0"
        ...
        <div className="flex items-center justify-between px-5 sm:px-6 pt-4 border-b border-slate-200 bg-slate-50 shrink-0">
          <div className="flex items-center gap-2">
            <button
              ...
              className={`pb-3 px-3 text-xs font-black transition-all flex items-center gap-2 border-b-2 cursor-pointer ${

        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-3 flex items-center gap-2">
            ...
            <button
              ...
              className="p-2.5 min-w-[44px] min-h-[44px] touch-target-44 inline-flex items-center justify-center rounded-xl text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-colors cursor-pointer focus-visible:ring-2 focus-visible:ring-claro"
            >

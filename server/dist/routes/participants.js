...
exports.participantsRouter.post("/bulk", async (req, res) => {
    ...
    try {
        ...
        for (const p of participants) {
            ...
            await client.query(`INSERT INTO participants (card, name, email, cedula, department, supervisor_id, supervisor_name, employment_status, is_active, company_id)
         ...
         ON CONFLICT (card) DO UPDATE SET
           ...
           company_id = EXCLUDED.company_id`, [card, name, email, cedula, department, supervisorId, supervisorName, employmentStatus, isActive, companyId]);
            ...
            if (userExists.rows.length === 0) {
                ...
                await client.query(`INSERT INTO users_simulated (id, email, name, role, password, cedula, department, employment_status, is_active, company_id)
           VALUES ($1, $2, $3, 'Colaborador (User)', '123', $4, $5, $6, $7, $8)
           ON CONFLICT (email) DO NOTHING`, [newUserId, email, name, cedula, department, employmentStatus, isActive, companyId]);
            }
            else {
           ...
           SET name = $1, 
               ...
               is_active = $5,
               company_id = $6
           WHERE LOWER(email) = $7`, [name, cedula, department, employmentStatus, isActive, companyId, email]);
            }
        }
...
exports.participantsRouter.put("/:card", async (req, res) => {
    ...
    try {
       ...
       SET name = $1, 
           ...
           is_active = $8,
           company_id = $9
       WHERE card = $10`, [cleanName, cleanEmail, cleanCedula, cleanDept, cleanSuperId, cleanSuperName, cleanEmpStatus, cleanIsActive, cleanCompanyId, cleanCard]);
